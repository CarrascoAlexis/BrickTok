...
class GameOverScreen(Scene):
    ...
    def render(self, screen):
        ...
        game_over_rect = game_over_surface.get_rect(center=(self.screen_width // 2, 150))
        screen.blit(game_over_surface, game_over_rect)
        
        # Render "SCORE" label
        score_label = "SCORE"
        label_surface = self.label_font.render(score_label, True, (200, 200, 200))
        label_rect = label_surface.get_rect(center=(self.screen_width // 2, 250))
        screen.blit(label_surface, label_rect)
        
        # Render final score
        score_text = str(self.score)
        score_surface = self.score_font.render(score_text, True, (255, 215, 0))
        score_rect = score_surface.get_rect(center=(self.screen_width // 2, 320))
